...
| Revocation API used by anyone to nullify any release | Open `POST /releases/{id}/revoke` | Revocation requires Entra authentication and an explicit `revoked_by` claim recorded in the audit row |
